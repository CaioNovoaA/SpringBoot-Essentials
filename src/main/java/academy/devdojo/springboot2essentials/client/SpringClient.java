...
public class SpringClient {
    public static void main(String[] args) {
        ...
        Anime samuraiChamplim = Anime.builder().name("Caio Novoa Antunes").build();
        ResponseEntity<Anime> samuraiChamplimSaved = new RestTemplate().exchange("http://localhost:8080/animes",
                HttpMethod.POST,
                new HttpEntity<>(samuraiChamplim),
                Anime.class);

                log.info("saved anime {}", samuraiChamplimSaved.getBody());
    }
